    ...
    <div class="container pt-2">
        ...
        <form action="{{Route('editProduct.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="proName" value="{{$pro->pro_name}}" name="proName" onkeyup="ChangeToSlug();">
                @if($errors->has('proName'))
                    <p class="text-danger">{{$errors->first('proName')}}</p>
                @endif
            </div>
            <div class="form-group">
                <label for="proSlug" class="font-weight-bold">Slug</label>
                <input type="text" class="form-control" id="proSlug" name="proSlug" value="{{$pro->pro_slug}}">
                @if($errors->has('proSlug'))
                    <p class="text-danger">{{$errors->first('proSlug')}}</p>
                @endif
            </div>
