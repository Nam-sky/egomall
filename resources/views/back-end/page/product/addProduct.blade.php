    ...
    <div class="container pt-2">
        ...
        <form action="{{Route('addProduct.store')}}" method="POST" enctype="multipart/form-data" id="form-product">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="proName" placeholder="Tên sản phẩm" name="proName" onkeyup="ChangeToSlug();">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="proSlug" name="proSlug">
